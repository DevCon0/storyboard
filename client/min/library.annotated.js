...
.controller('libraryCtrl', ['$scope', '$state', 'StoryStorage', 'localStorageService', 'Auth', '$stateParams', function ($scope, $state, StoryStorage, localStorageService, Auth, $stateParams) {
